...
# ALTERAR TAMBÈM AS DATAS NO CRIANCAS def create e no def uppdate
    ...
    for crianca in @criancas_alteracao
      anterior = crianca.grupo_id
       if (crianca.nascimento < '2019-01-01'.to_date and crianca.nascimento >= '2017-06-01'.to_date)
           crianca.grupo_id = 1
       else if(crianca.nascimento < '2017-06-01'.to_date and crianca.nascimento >= '2016-07-01'.to_date)
               crianca.grupo_id = 2
