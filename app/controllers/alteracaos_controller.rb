  ...
  def alterar_classe
    ...
    for crianca in @criancas_alteracao
      anterior = crianca.grupo_id
       if (crianca.nascimento < '2018-01-01'.to_date and crianca.nascimento >= '2016-02-01'.to_date)
           crianca.grupo_id = 1
       else if(crianca.nascimento < '2016-02-01'.to_date and crianca.nascimento >= '2015-07-01'.to_date)
               crianca.grupo_id = 2
